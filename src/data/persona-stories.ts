...
QBR本番。顧客から「先月報告したバグはどうなりました？」と聞かれます。サポートに聞いたがJira番号までは教えてもらえませんでした。「確認して折り返します」。また誰かに聞いて、待ちます。`,
...
• 部署の壁を越えた情報が、権限設計のもとで1画面に集まっています`,
  ...
  developer: {
    persona: 'developer',
    before: `開発者のスプリントプランニング。Jiraに48件のBacklogがあります。うち12件はサポートからの転記ですが、「お客様が〇〇でお困りです」としか書かれていません。再現手順がない。影響範囲もわかりません。
...
「サポート負荷が高い機能は？」→ Part Distributionチャートで即答。ドリルダウンして「修正予定はNext Sprint」まで確認。部門長に聞く必要がありません。
...
• Afternoon free time used to add 1 KB article → fewer similar tickets next week`,
  ...
  sales: {
    persona: 'sales',
    before: `The sales rep is preparing for tomorrow's QBR. Contract info is in Salesforce - accessible. But ticket status lives in the support team's Zendesk. No access. Slack the support lead: "Can you share Account A's ticket status?" Wait for a reply.
